...
<head>
    ...
    <script src="/resources/js/adminCalendar.js"></script>
</head>
<body>
...
<div class="row">
    <div id="page-wrapper"  style="width:90%; margin:0 auto;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Редактирование календаря
                    <div id="add_event_button" style="float: right; font-size:0.4em" >Добавить событие</div>
                </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row addOrder admin">
            <div class="row">
                ...
                <div id="calendar" style="margin-bottom: 2em;"></div>
                <%--<div class="btn btn-primary" id="add_event_button" >Добавить событие</div>--%>
...
<%--<!-- jQuery -->--%>
<%--&lt;%&ndash;<script src="/resources/admin/bower_components/jquery/dist/jquery.min.js"></script>&ndash;%&gt;--%>
