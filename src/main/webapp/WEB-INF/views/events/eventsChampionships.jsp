        ...
        <div class="row mainBlockWrapper">
            <div class="cols col-8 centered">
                <div class="mainBlock blog">
                    <h3 class="blockTitle"><span class="locale" data-name="championships_title"></span></h3>

                    <div class="logoSmall">
                        <img src="/resources/img/championshipsSmall.png" alt="">
                    </div>
                    <div class="row">
                    ...
                    <div class="pageNav bottom">
                        <ul>
                            ...
                            %>
                            <li><a href="/championships/<%=i%>"><%=i%></a></li>
                            <%
                                }
                            %>
                        </ul>
