...
<div class="container">
    <div class="page-wrapper">
        ...
        <div class="row mainBlockWrapper leaderPage">
            <div class="cols col-8 centered">
                <ul>
                    <li><span style="text-align: center; margin: 1em 0 1.5em 0; font-size: 1.3em;">Федерация конного спорта Полтавской области</span>
                    </li>
